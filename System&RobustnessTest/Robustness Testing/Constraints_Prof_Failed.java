...
public class Constraints_Prof_Failed {
  ...
  @Test
  public void Constraints_Prof_Invalid_StartTime() throws Exception {
	String user = "tom";
	String pwd= "sutd1234";
    ...
    driver.findElement(By.name("startTime")).sendKeys("08:00");
  ...
  @Test
  public void Constraints_Prof_Invalid_EndTime() throws Exception {
	String user = "tom";
	String pwd= "sutd1234";
    driver.get("http://35.198.199.181:5000/");
    driver.findElement(By.name("username")).click();
    ...
    driver.findElement(By.name("endTime")).click();
    driver.findElement(By.name("endTime")).clear();
    driver.findElement(By.name("endTime")).sendKeys("20:00");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='End Time'])[1]/following::input[2]")).click();
